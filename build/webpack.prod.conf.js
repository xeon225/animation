...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      filename: process.env.NODE_ENV === 'testing'
        ? '/animation/lineChart.html'
        : config.build.lineChart,
    ...
    new HtmlWebpackPlugin({
      ...
      chunksSortMode: 'dependency',
      chunks: ['manifest', 'vendor', 'myyh']
    }),

    // 马姨呀嘿Path
    new HtmlWebpackPlugin({
      filename: process.env.NODE_ENV === 'testing'
        ? '/animation/myyhPath.html'
        : config.build.myyhPath,
      ...
      chunksSortMode: 'dependency',
      chunks: ['manifest', 'vendor', 'myyhPath']
    }),

    // 伪类合集
    new HtmlWebpackPlugin({
      filename: process.env.NODE_ENV === 'testing'
        ? '/animation/pseudo.html'
        : config.build.pseudo,
    ...
    new HtmlWebpackPlugin({
      filename: process.env.NODE_ENV === 'testing'
        ? '/animation/specification.html'
        : config.build.specification,
      ...
      chunksSortMode: 'dependency',
      chunks: ['manifest', 'vendor', 'specification']
    }),
